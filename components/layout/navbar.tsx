  ...
  return (
    <header className="z-50 sticky top-0">
      <nav aria-label="Navegación principal">
        <div className="duration-300 backdrop-filter backdrop-blur-3xl backdrop-saturate-200 transition-shadow items-center w-full flex flex-col xs:flex-row justify-between bg-white/80 dark:bg-black/75 z-50 dark:shadow-nav-dark shadow-nav">
        ...
        {isOpen && (
          <div className="absolute px-6 py-4 top-16 flex flex-col xs:hidden backdrop-filter backdrop-blur-2xl backdrop-saturate-200 transition-shadow bg-white/80 dark:bg-black/75 w-full rounded-b-2xl shadow-lg dark:shadow-gray-900 ">
            <ul>
              {NAV_ITEMS.map((item) => (
                <li
                  key={item.path}
